...
**cursor-rules-cli** — командная утилита для управления правилами в проектах. Упрощает установку, обновление и настройку правил через удобный интерфейс.
...
**Инициализация правил в проекте:**
...
**Обновление правил до последней версии:**
...
```bash
cursor-rules-cli config
```

Интерактивное меню для выбора языка интерфейса (ru/en) и других настроек.
...
CLI сохраняет настройки в глобальной конфигурации пользователя (например, язык интерфейса). Конфигурация хранится в системной директории и применяется ко всем проектам.

> **💡 Совет:** Используйте `cursor-rules-cli config` для настройки языка интерфейса и других параметров перед первым использованием.
