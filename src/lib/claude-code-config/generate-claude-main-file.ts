...
/**
 * Генерирует блок правил для вставки в существующий CLAUDE.md
 * @param rules - Массив правил с alwaysApply: true
 * @param docsCatalogContent - Содержимое docs-catalog.md
 * @returns Блок правил, обёрнутый в теги
 */
export function generateClaudeRulesBlock(rules: AlwaysApplyRule[], docsCatalogContent: string): string {
    const parts: string[] = [];

    parts.push('<!-- CLAUDE-RULES-START -->');
    parts.push('');
    parts.push(`<!--`);
    parts.push(`AUTO-GENERATED by ai-rules-kit`);
    parts.push(`DO NOT EDIT THIS BLOCK MANUALLY`);
    parts.push(`Source: https://github.com/CyberWalrus/ai-rules-kit`);
    parts.push('-->');
    parts.push('');
    parts.push(`## Project AI Rules`);
